...
Compile a simple SELECT benchmark with `github.com/mattn/go-oci8` and `github.com/patrickascher/ora`, and compare them:
...
(pprof) :tgulacsi@tgulacsi-laptop: ~/src/github.com/patrickascher/ora/examples/bench
```
